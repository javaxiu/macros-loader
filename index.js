...
function replaceFilename(content, filename, reg) {
  filename = filename.replace(/\\/g, '/');
  return content.replace(/__FILE__/g, (filename.match(reg) || [filename])[0]);
}
...
module.exports = function (content) {
  ...
  content = replaceFilename(content, this.resourcePath, config.reg);
